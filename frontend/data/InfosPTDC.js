export const InfosPDTC = {
  principio: [
    {
      cod: "P1",
      title: "Universidade popular com diversidade social e interculturalidade",
      description:
        "A Unifesspa nasce de demandas e lutas sociais. Foi concebida para defender e incorporar o respeito à diversidade social, cultural e ambiental e aos direitos humanos, em uma região com imensas desigualdades sociais. Legado que deve impulsionar a busca pelo reforço de seu caráter popular e intercultural, a valorização da diversidade de sua comunidade, a efetiva inclusão de estudantes de diversas origens e experiências. Neste contexto, para se promover excelência acadêmica, é essencial adotar uma política intercultural, com currículos que combatam discriminações e garantam representatividade. A interculturalidade deve permear todas as atividades universitárias, valorizando saberes diversos e fomentando a cidadania ativa. O respeito, empatia e diálogo são fundamentais para fortalecer a convivência e promover a diversidade, estimulando a expressão cultural e artística dos estudantes. A Unifesspa precisa continuar evoluindo e implementar mudanças estruturais para consolidar seu projeto de universidade inclusiva e diversa.",
      icon: "cap",
    },
    {
      cod: "P2",
      title:
        "Universidade como espaço de aprendizado com ações Indissociáveis (ensino-pesquisa-extensão) e pautada em problemas socialmente relevantes",
      description:
        "Tradicionalmente, as universidades valorizavam a disseminação do conhecimento científico e/ou cultural como a atividade principal, mas com a evolução democrática, o foco educacional mudou para se tornar mais inclusivo e justo. Na região da Amazônia, a defesa da universidade pública reflete a busca por uma educação popular, exigindo uma revisão na política de Ensino-Pesquisa-Extensão da Unifesspa. A escuta por nós realizada destacou a importância de integrar ciência, arte e cultura para fortalecer a universidade, adaptar programas acadêmicos para melhor acesso dos alunos e reestruturar laboratórios e grupos de pesquisa. A expansão da Unifesspa e a aproximação com comunidades locais são consideradas essenciais para uma presença efetiva. No contexto atual, as universidades enfrentam desafios com impacto das tecnologias, globalização e difusão do conhecimento, o que requer reflexão sobre os novos papéis da instituição. A integração entre Ensino-Pesquisa-Extensão é crucial, adaptando-se às demandas da sociedade e promovendo inovações pedagógicas. Assim a Unifesspa de ser capaz de promover de mudanças coletivas, reforçando a integração entre membros e incentivando o diálogo com a comunidade, visando promover aprendizado contínuo e eficaz. O envolvimento de todos os agentes educacionais e a criação de espaços propícios para interação interpessoal são chave para enfrentar os desafios atuais e garantir a indissociabilidade entre Ensino-Pesquisa-Extensão.",
      icon: "cap",
    },
    {
      cod: "P3",
      title: "Universidade democrática e autônoma",
      description:
        "O binômio democracia e autonomia são fundamentais para a construção de ações da Unifesspa, desde a formação de agenda até os processos decisórios. A concepção de principios rege a democracia, que está em constante mudança e é construída coletivamente em assembleias. As formas e funções da democracia incluem o diálogo e a concertação de demandas coletivas entre os diferentes grupos sociais da universidade. A participação majoritária dos representantes estudantis, dispositivos para atender demandas das minorias, democratização do planejamento financeiro e orçamentário e ampliação dos espaços presenciais para tomada de decisões também são importantes.",
      icon: "cap",
    },
    {
      cod: "P4",
      title: "Universidade com integração multicampi",
      description:
    ...
    {
      cod: "P7",
      title: "Universidade com acolhimento saúde e qualidade de vida",
      description:
  ...
  diretriz: [
    {
      cod: "D1",
      title: "Acolhimento, Inclusão Social e Diversidade",
      description:
        "Descubra como estamos comprometidos em promover um ambiente acolhedor e inclusivo para todos os membros da nossa comunidade acadêmica.",
    },
    {
      cod: "D2",
      title: "Gestão Democrática e Participativa",
      description:
        "Explore nosso compromisso com uma administração transparente e inclusiva, onde todos têm voz nas decisões que moldam o futuro da universidade.",
    },
    {
      cod: "D3",
      title: "Gestão Ecológica e Humanizada dos Espaços",
      description:
        "Conheça como estamos comprometidos em promover práticas sustentáveis e um ambiente acolhedor, priorizando o bem-estar de nossa comunidade acadêmica e o cuidado com o meio ambiente.",
    },
    {
      cod: "D4",
      title: "Integração: arte, cultura, esporte, lazer e ciência ",
      description:
        "Saiba como promovemos a integração entre essas áreas, enriquecendo a experiência acadêmica e fortalecendo os laços comunitários.",
    },
    {
      cod: "D5",
      title: "Política Institucional com Transparência",
      description:
        "Implementando políticas transparentes para fortalecer a confiança e a participação na comunidade acadêmica.",
    },
    {
      cod: "D6",
      title: "Retomar a Expansão com Planejamento e Diálogo",
      description:
        "Nosso compromisso é retomar a expansão de forma sustentável, guiados pelo diálogo e um planejamento cuidadoso, visando o crescimento equitativo e inclusivo da nossa comunidade acadêmica.",
    },
    {
      cod: "D7",
      title: "Suporte eficiente ao ensino, à pesquisa e à extensão",
      description:
        "Oferecendo suporte eficiente e abrangente ao ensino, pesquisa e extensão para impulsionar o desenvolvimento acadêmico e social.",
    },
    {
      cod: "D8",
      title: "Trabalho Digno com Saúde e Qualidade de Vida",
      description:
        "Priorizando um ambiente de trabalho digno, onde a saúde e qualidade de vida são valores essenciais para todos os membros da comunidade acadêmica.",
    },
    {
      cod: "D9",
      title:
        "Vivências Formativas e a Indissociabilidade Ensino, Pesquisa e Extensão",
      description:
        "Integrando experiências formativas que unem ensino, pesquisa e extensão para uma educação holística e significativa.",
    },
  ],
  compromisso: [
    {
    ...
    {
      title: "Ampliar e aprimorar as formas de ingresso na Unifesspa",
      cod: 3,
    },
    {
      title: "Ampliar e institucionalizar os espaços de escuta e de debates",
      cod: 4,
    },
    {
      title:
    ...
    {
      title: "Aperfeiçoar os Sistema Polare de acompanhamento ao PGD",
      cod: 6,
    },
    {
      title:
    ...
    {
      title: "Avaliar e promover ajustes no desenho institucional da Unifesspa",
      cod: 13,
    },
    {
      title:
    ...
    {
      title: "Avançar e institucionalizar políticas de combate ao racismo",
      cod: 15,
    },
    {
      title: "Avançar nas relações internacionais",
      cod: 16,
    },
    {
      title:
    ...
    {
      title: "Avançar e institucionalizar políticas de combate à LGBTfobia",
      cod: 19,
    },
    {
      title:
    ...
    {
      title: "Disponibilizar infraestrutura às entidades estudantis",
      cod: 33,
    },
    {
      title:
    ...
    {
      title: "Enfrentar o problema da evasão estudantil",
      cod: 35,
    },
    {
      title:
    ...
    {
      title: "Estabelecer uma política de moradia estudantil multicampi",
      cod: 39,
    },
    {
      title: "Estimular a integração ensino-pesquisa-extensão",
      cod: 40,
    },
    {
      title:
    ...
    {
      title: "Fomentar os intercâmbios interculturais",
      cod: 44,
    },
    {
      title:
    ...
    {
      title: "Fortalecer a política de monitoria estudantil",
      cod: 47,
    },
    {
      title:
    ...
    {
      title: "Garantir a atualização e a ampliação do acervo bibliográfico",
      cod: 52,
    },
    {
      title:
    ...
    {
      title: "Garantir recursos para as viagens de campo",
      cod: 58,
    },
    {
      title:
    ...
    {
      title: "Implementar o Portal Alumni-Unifesspa para integrar os egressos",
      cod: 61,
    },
    {
      title:
    ...
    {
      title: "Incentivar e apoiar à participação discente em eventos",
      cod: 65,
    },
    {
      title:
    ...
    {
      title: "Fortalecer a comissão de acessibilidade",
      cod: 69,
    },
    {
      title:
    ...
    {
      title: "Investir em políticas de qualificação dos servidores",
      cod: 74,
    },
    {
      title: "Investir na gestão, adequação e expansão de laboratórios",
      cod: 75,
    },
    {
      title:
    ...
    {
      title: "Promover feiras de saúde",
      cod: 79,
    },
    {
      title:
    ...
    {
      title: "Realizar levantamento patrimonial completo ",
      cod: 95,
    },
    {
      title:
    ...
    {
      title: "Regulamentar e assegurar recebimento de bolsas pelos TAEs ",
      cod: 97,
    },
    {
      title:
